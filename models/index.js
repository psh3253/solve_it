...
const CodingQuestionStatus = require('./coding_question_status');
...
db.CodingQuestionStatus = CodingQuestionStatus;
db.Coupon = Coupon;
...
CodingQuestionStatus.init(sequelize);
...
CodingQuestionStatus.associate(db);
Coupon.associate(db);
